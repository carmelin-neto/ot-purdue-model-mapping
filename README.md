...
This segmentation design is the foundation referenced in my Incident Response scenario and ICS attack testing — the ACL enforced here is what contains the attack in both.
